...
_RELEVANCE_SYSTEM_PROMPT = (
    ...
    "the page. A long page may be spliced: its opening, a "
    "\u27ea outmem: … \u27eb note marking omitted middle, then the passage "
    "around the query terms (prefixed with its [section: …] heading path "
    "when known).\n\n"
